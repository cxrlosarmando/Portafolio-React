                    ...
                    <div className="relative flex h-20 items-center justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            <div className="flex flex-shrink-0 items-center">
                                <h1 className="text-3xl text-white">Hola Soy Carlos</h1>
                            </div>
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-6">
                                    <a
                                        href="#Inicio"
                                        className="rounded-md bg-gray-900 px-4 py-3 text-lg font-semibold text-white"
                                        aria-current="page"
                                    >
                                        Inicio
                                    </a>
                                    <a
                                        href="#Proyectos"
                                        className="rounded-md px-4 py-3 text-lg font-semibold text-gray-300 hover:bg-gray-700 hover:text-white"
                                    >
                                        Proyectos
                                    </a>
